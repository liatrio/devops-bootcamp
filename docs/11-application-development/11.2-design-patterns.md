...
![Design Patterns and SOLID Principles Connection](./img11/patterns_solid_connection.png ':class=img-center :alt=Design Patterns and SOLID Principles Connection :width=600')
