...
1. Read about the Kubernetes autoscalere [here](https://docs.aws.amazon.com/eks/latest/userguide/cluster-autoscaler.html)
...
- Discuss why the policy added in the autoscaler exercise might be a bad idea ([this is an alternative](https://aws.amazon.com/blogs/opensource/introducing-fine-grained-iam-roles-service-accounts/))
