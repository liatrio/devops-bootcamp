...
4. Create a Launch Template with a Kubernetes optimized AMI. The instance type should be T3.medium because Kubernetes needs more resources
5. Specify your launch template when creating a Node Group to launch Kubernetes EC2 images
