...
In this exercise we will create an Classic Load Balancer in AWS which distributes traffic to the two instances created.
...
- Try stopping the Tomcat service in an instances created by the auto scaling group.
  - What happens the the health status?
