...
In this exercise we will create an EC2 instance and use a User Data script to provision the instance as host for a Java web application. We recommend configuring a machine to run [Spring's PetClinic Project](https://github.com/liatrio/spring-petclinic) on [CentOS Stream 9](https://www.centos.org/download/aws-images/). But you are free to do this exercise with another web application and distro.
