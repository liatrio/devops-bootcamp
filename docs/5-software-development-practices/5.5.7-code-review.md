...
- **Have good intentions.** The reviewer and developer should both be going into the process with the intention of introducing quality code into the codebase.
