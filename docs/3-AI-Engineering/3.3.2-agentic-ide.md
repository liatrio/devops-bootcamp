...
You should provide this context to the AI before letting it start developing:

- [MCP Full Text](https://modelcontextprotocol.io/llms-full.txt)
- [Python MCP SDK](https://raw.githubusercontent.com/modelcontextprotocol/python-sdk/refs/heads/main/README.md)

If you do not have VSCode installed you can download it [here](https://code.visualstudio.com/).

**Goal**
With VSCode in Agent mode build an MCP server from scratch.

Register your MCP server with some MCP client (Claude Desktop, Windsurf, VSCode etc.) verify it works.
