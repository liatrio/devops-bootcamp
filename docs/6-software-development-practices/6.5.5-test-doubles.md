...
Code for this exercise can be found in the [codeQuality/jest-mock repo.](https://github.com/liatrio/engineering-bootcamp/tree/master/examples/codeQuality/jest-mock)
