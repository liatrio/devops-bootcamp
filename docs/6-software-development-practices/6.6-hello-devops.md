...
![ticket image](img6/ticket_light.svg ':size=100x100 :class=light-mode-icon  :alt= ticket image; light mode')
![ticket image](img6/ticket_dark.svg ':size=100x100 :class=dark-mode-icon :alt= ticket image; dark mode')
