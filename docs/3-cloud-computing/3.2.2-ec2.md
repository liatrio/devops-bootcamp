...
![jenkins_workflow](./img3/cloudbees_jenkins_workflow.png ':class=light-mode-img-center')
...
![jenkins_agent_controller](./img3/jenkins-agent-controller.png ':class=light-mode-img-center')
