...
6. Next we will use a Kubernetes deployment to deploy our Jenkins pod. Fork the [bootcamp repository](https://github.com/liatrio/devops-bootcamp.git) if you haven't already and navigate to the Jenkins deployment definition in the folder `examples/ch7/jenkins-deployment.yaml`. 
...
9. We need a service to expose our jenkins deployment. Apply the service definition configuration at `examples/ch7/jenkins-services.yaml`. 
