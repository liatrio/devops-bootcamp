...
## The Goal
Take the pain out of software delivery and deployment.
...
3) The artifacts delivered are the product! Remember this! Every build created could potentially go to production. We also need to consider that programs can depend on other artifacts. We use tools such as Maven and Nexus to keep track of dependencies and versions.
