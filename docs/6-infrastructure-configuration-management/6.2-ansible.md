...
> For the following exercises, you will need to choose a GitHub repository to work with. You can reuse your `getting-started` repo from previous chapters. 
...
2. Write an Ansible playbook to install the a GitHub self-hosted runner.
