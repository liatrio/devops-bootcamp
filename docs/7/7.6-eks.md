...
![An overview of Kubernetes cluster components. A developer is shown interacting with the API server, while a user interacts with the Kube-Proxy](./img7/kubernetes-overview.svg ':class=img-center')
...
![An overview of EKS architecture.](./img7/eks.webp ':class=img-center')
