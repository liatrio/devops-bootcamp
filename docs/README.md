...
- To add a new section, add a new file to `docs` such as `x.x-new-section.md`, and then reference it in `docs/_sidebar.md`.  Please note: this will also generate new front matter in `docs/README.md`.
