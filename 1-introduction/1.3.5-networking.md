...
![computer networking image](img1/computer_network_light.svg ':size=150x150 :class=light-mode-icon')
![computer networking image](img1/computer_network_dark.svg ':size=150x150 :class=dark-mode-icon')
