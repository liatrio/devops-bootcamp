...
![case studies image](img1/case_studies_icon_light.svg ':size=150x150 :class=light-mode-icon')
![case studies image](img1/case_studies_icon_dark.svg ':size=150x150 :class=dark-mode-icon')
