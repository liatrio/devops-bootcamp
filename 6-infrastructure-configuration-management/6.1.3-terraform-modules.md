...
1. Review the configuration first. The ` source = "./modules/s3-bucket"`  declare the local module directory and module thats being used for the modules in this configuration.
