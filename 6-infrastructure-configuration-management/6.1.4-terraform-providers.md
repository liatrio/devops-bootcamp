...
4. Once you are done setting up the repository you can press the `create repostory from template` and this should start generating the repo from terraform-provider-scaffolding.
