...
2. Use the provided [Makefile](https://github.com/liatrio/devops-bootcamp/blob/4503cf73612b1e5be73e4f9d13717d0e157c4d0f/examples/ch6/provider-setup/Makefile) and the [Script]() that goes with it to initialize your repo. You will be asked later to analyze this Makefile and understand what it is doing in a deliverable. For now use it to get started.
