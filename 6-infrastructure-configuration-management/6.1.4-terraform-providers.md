...
internal to the provider. This schema should mirror the API data structure.[schema docs](https://developer.hashicorp.com/terraform/plugin/framework/schemas)
