...
> _**Note**_ We are going to be refrencing the Hashicorp documentation throughout the next excersise
...
> **_NOTE:_** We are going to have to implement the other CRUD operations, please look at the Hashicorp documentation as a refrence.

## Exercise 5: implementing the Wrapper

> **_Disclamer:_** You can choose to take a different route as long as it does not take an absurd amount of time
...
?> For the wrapper you do not have to implement a models.go - reference [devops-resource]() documentation to reference this module to be used in place of models.go
