...
2. Use the provided Makefile to initialize your repo. You will be asked later to analyze this Makefile and understand what it is doing in a deliverable. For now use it to get started.
    ``` bash
...
?> Some basic testing will be provided for engineers as a starting point for the challenge. It is encouraged to include more testing for your resources and datasources to ensure proper functionality for what was envisioned.
   ...
   - Here is what some simple acceptance testing would look like for an Engineer resource:
```
package provider
...
### Exercise 5: Implementing Dev, Ops, DevOps resource and datasource
